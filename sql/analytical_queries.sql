...
-- ============================================================
-- Q9: CAMPAIGN ROI (REVENUE PER GBP SPENT)
-- Purpose: Rank campaigns by marketing efficiency
-- Key Findings:
--   - Cyber Monday: highest revenue-per-pound at 5,329% marketing ROI
--   - Back to School: £1,172 revenue per £1 spent
--   - Ramadan Season: £1,137 per £1 (misleading - low absolute lift)
--   - Christmas: £1,082 per £1 (high absolute revenue)
--   - Efficiency (ROI) and effectiveness (absolute revenue) rank campaigns differently
-- ============================================================
SELECT 
    c.campaign_name,
    c.start_date,
